package com.king.app.m_easelib.ui;
...
import com.king.app.m_easelib.utils.EaseImageUtils;
import com.king.app.m_easelib.utils.EaseUserUtils;
import com.king.app.m_easelib.widget.EaseAlertDialog;
import com.king.app.m_easelib.widget.EaseChatExtendMenu;
import com.king.app.m_easelib.widget.EaseChatInputMenu;
import com.king.app.m_easelib.widget.EaseChatMessageList;
import com.king.app.m_easelib.widget.EaseVoiceRecorderView;
...
public class EaseChatFragment extends EaseBaseFragment implements EMEventListener {
    ...
    protected void setUpView() {
        ...
        // TODO: 2016/4/6 聊天页面标题设置
        //        titleBar.setTitle("技术咨询");
        ...
        switch (type) {
            case TXT:
                if (forward_msg.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    sendBigExpressionMessage(((TextMessageBody) forward_msg.getBody()).getMessage(), forward_msg.getStringAttribute(EaseConstant.MESSAGE_ATTR_EXPRESSION_ID, null));
                } else {
                    // 获取消息内容，发送消息
